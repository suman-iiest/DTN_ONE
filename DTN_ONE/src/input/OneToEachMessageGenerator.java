...
public class OneToEachMessageGenerator extends MessageEventGenerator {
	...
	public ExternalEvent nextEvent() {
	    ...
	    {             
	    	mce = new MessageCreateEvent(from, to, this.getID(), drawMessageSize(), responseSize, this.nextEventsTime,this.is_multicast,multicast_destinations(hostRange, from));
	    }
