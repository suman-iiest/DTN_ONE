 ...
 */
public class TotalContactDuration extends Report implements ConnectionListener {
	...
	@Override
	public void done() {
		int totalContacts=0, totalDuration=0;
		for (int i=0, n=this.nrofContacts.size(); i<n; i++) {
			...
			totalDuration += i*this.granularity*contacts;
		}
		
		write("Total Contacts:"+totalContacts + "\nTotal Duration: " + totalDuration);
